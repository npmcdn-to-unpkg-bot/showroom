angular.module("content", ['KM_tools', 'MockDb', 'socket.io', 'infinite-scroll', 'ui.router', 'ngAnimate', 'ngSanitize']).config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
	$stateProvider.state('index_web', {
		url: "/index_web",
		abstract: true,
	...
	$scope.messageList = [{ text: 'Hello. What can I do for you?' }, { text: 'I\'m just looking around. Will you tell me something about yourself?' }, { text: 'OK, my name is Limingqiang. I like singing, playing basketballand so on.' }, { text: 'I am Derek. I am a photographer.' }];
	...
	$scope.addPost = function () {
		var messageImageFile = document.getElementById("messageImage"),
		    messageFileFile = document.getElementById("messageFile"),
		    file,
		    images = [],
		    attachments = [];
